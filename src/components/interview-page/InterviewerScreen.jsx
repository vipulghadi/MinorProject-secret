...
function InterviewerScreen() {
  ...
  <div className="finish-btn px-3 py-2 bg-red-500 text-primary absolute right-5 top-1 font-semibold rounded-sm">Finish</div>
  <div className="timer text-primary text-[18px] absolute top-3 left-4">20:40 sec</div>
